...
getBallsMap :: Map Int Ball
getBallsMap = fromList [(1, B.Ball 1 (0.9, 0.9) (0.0, 0.1) 0.05 0 0),
                        (2, B.Ball 2 (0.8, 0.8) (0.0, 0.2) 0.05 0 0), 
                        (3, B.Ball 3 (0.3, 0.7) (0.0, 0.3) 0.05 0 0)]

getPolygonsMap :: Map Int GamePolygon
getPolygonsMap = fromList [(1, P.GamePolygon 1 (0,0) [(0.1, 0.2), (0.1, 0.4), (0.2, 0.4)]),
